...
# Load data
inp_dir = r"C:\Users\Administrator\PycharmProjects\Stock-Prediction\knn\data"
inp = os.path.join(inp_dir, "AAPL.csv")
data = np.array(pd.read_csv(inp, index_col = "Date")["Close"])
